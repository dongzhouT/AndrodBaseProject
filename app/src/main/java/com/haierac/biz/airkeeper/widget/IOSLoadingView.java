...
//    private String[] color = {"#919191", "#9C9C9C", "#999999", "#B0B0B0", "#C1C1C1", "#DBDBDB", "#E9E9E9", "#FFFFFF",};
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        heigheRect = (int) (3.5 * widthRect + 0.5f);  //菊花矩形的高
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            canvas.rotate(rotateDegree, width / 2, width / 2);    //旋转
        }
        ...
        postInvalidateDelayed(80);  //一个周期用时ns
